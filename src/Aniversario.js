...
function Aniversario() {
  ...
  const divStyle1 = {
    fontSize: '200px',
    fontWeight: '900',
    backgroundImage: `url(${process.env.PUBLIC_URL}/IMG_6894.jpg)`, // Caminho para a imagem
    backgroundSize: 'cover',
  ...
  const textStyle = {
    ...
    top: '50%', // Ajuste a posição vertical do texto conforme necessário
    left: '50%', // Ajuste a posição horizontal do texto conforme necessário
    transform: 'translate(-50%, -50%)', // Centralizar o texto no elemento pai
  };
  return (
    <div>
      <div style={divStyle}>
      ...
      <ContentContainer>
        <Row>
          <Col>
            <div xs={6}>
              <p className='aniv-text' >Ainda hoje de cariz familiar, a TRANSCARP, é uma sociedade comercial por quotas a qual, na origem,
          ...
          <Col className='aniv-div1' xs={6}>
            <img src={anivImg} alt="aniv" className='aniv-img' />
          </Col>
        </Row>
      </ContentContainer>
    </div >
